        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource() == equipesCadastradas) {
                ...
                for (Equipe eq : equipes.getEquipesCadastradas()) {
                    area.append("---EQUIPE---" + eq.equipeToString());
                    area.append("\n\n");
                }
            }
    ...
    public void criaObjeto() {
        ...
        do {
            if (!var2.hasNext()) {
                int quantidade = 0;
                try{
                    if (quantidadeTextField.getText().isEmpty() || codinomeTextField.getText().isEmpty() || latitudeTextField.getText().isEmpty() || longitudeTextField.getText().isEmpty()) {
                    throw new CampoVazio("Todos os campos devem ser preenchidos!");
                    }
                    quantidade = Integer.parseInt(quantidadeTextField.getText());
                    } catch (CampoVazio b) {
                        area.setText(b.getMessage());
                        JOptionPane.showMessageDialog(JanelaEquipe.this, b.getMessage());
                    } catch (NumberFormatException var10) {
                        area.setText("Erro: Quantidade inválida. Insira um valor numérico inteiro.");
                        JOptionPane.showMessageDialog(JanelaEquipe.this, var10.getMessage());
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(JanelaEquipe.this, "Erro: Longitude inválida. Insira um valor numérico.");
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(JanelaEquipe.this, "Erro: Latitude inválida. Insira um valor numérico.");
                        latitudeTextField.setText("");
                        return;
                    }
        ...
        JOptionPane.showMessageDialog(JanelaEquipe.this, "Erro: Uma equipe já existe com este codinome");
